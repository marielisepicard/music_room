//
//  DeleteTrackInEvent.swift
//  musicroomfortytwo
//
//  Created by Tristan Leveque on 19/03/2021.
//

import Foundation

extension Event {
    func deleteTrack(trackId: String, callback: @escaping (Bool, Int) -> Void) {
        var task: URLSessionTask?
        let route = UserDefaults.standard.string(forKey: "route")!
        var urlStr = route + "/events/" + self.id!
        urlStr += "/tracks/" + trackId
